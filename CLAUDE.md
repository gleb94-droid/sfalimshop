...
- **`main` = `launch-prep` = `e5c525f`** (in sync; deployed behind gate, Vercel ● Ready). On main now: the home entrance "wow" effects (aurora glow + mobile device-tilt card + staggered hero headline) and the 2026-06-07 batch-4 perf/polish below. The create-payment **v20** quantity-clamp is also deployed (live edge fn).
