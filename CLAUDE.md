...
- Status: **🚀 LIVE — soft-launched 2026-06-10.** All 3 launch gates flipped (commit `d912831` on `main`, Vercel Ready, verified — `robots: index, follow`, real shop public, no maintenance page). Soft launch = no announcement yet (owner to place a real test order, then advertise on IG/FB). Reversible: flip the 3 gates back to re-gate.
...
- **🚀 LIVE: Production = `main` = `launch-prep` = `d912831`** (Vercel Ready, public + indexable — gates flipped 2026-06-10). **The site is OPEN to the public** — full shop, blog, and the Sfali assistant are all visible now. Soft launch (no announcement yet). To re-gate (pull private again): flip the 3 gates back.
...
**✅ LAUNCHED 2026-06-10** — the 3 gates are flipped + live (`main` = `launch-prep` = `d912831`, fully in sync). To re-gate (pull the site private again): flip all 3 back to the left value.
