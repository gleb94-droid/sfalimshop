...
## 📌 CURRENT STATE (as of 2026-06-07) — read this first

> Source of truth. Where older notes (changelog below) conflict, this wins.

### 🚀 Production / branch state
- **Production = `main` = `launch-prep` = `6e29579`** (in sync; deployed behind the maintenance gate, all 3 launch flags still ON, Vercel ● Ready). Public sees the maintenance page → "Explore the BLOOM collection" → `/pets` gallery + waitlist (**no blog in the preview**); launch = flip the 3 flags.
