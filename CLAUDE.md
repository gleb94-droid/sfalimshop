...
## 📌 CURRENT STATE (as of 2026-06-18) — read this first
...
- **🚀 LIVE: Production = `main` = `launch-prep` = `6a03dbf`** (Vercel Ready, public + indexable — gates flipped 2026-06-10). **The site is OPEN to the public** — full shop, blog, Sfali all visible. Soft launch (no announcement yet). To re-gate: flip the 3 gates back.
