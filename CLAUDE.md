...
- ✅ **Breed-page polish DONE** (2026-05-30, commit `adbe5ab`): hero image now `object-fit:contain` in a 4/5 framed box with a visible orange border (full image, no crop); thumbnail strip is a labeled active-highlighted **view selector** (portrait / white tee / black tee / mug, trilingual); pet-name field restyled into the premium personalization block. App.jsx only.
